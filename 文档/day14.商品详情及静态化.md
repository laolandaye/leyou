...
public class GoodsService {
    ...
    public Map<String, Object> loadData(Long spuId){
        ...
        // 查询规格参数组
        List<SpecGroup> groups = this.specificationClient.queryGroupsByCid(spu.getCid3()).getBody();

        // 查询特殊的规格参数
        List<SpecParam> params = this.specificationClient.queryParams(null, spu.getCid3(), null, false).getBody();
...
![1579426247260](assets/1579426247260.png)
